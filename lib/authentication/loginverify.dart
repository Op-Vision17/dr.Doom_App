...
class Loginverify extends ConsumerWidget {
  final String email;

  const Loginverify({Key? key, required this.email}) : super(key: key);

  Future<void> loginVerifyOtp(BuildContext context, WidgetRef ref) async {
